...
class LSHash(object):
    ...
    def __init__(self, hash_size, input_dim, num_hashtables=1,
        ...
        self.hash_size = hash_size   # 哈希值用几位数字编码
        ...
        # 用来存储 uniform random planes (这些random planes可用来计算hash值)
        ...
        # 构建self.uniform_planes, shape: (num_hash_table, hash_size, feature_dim)
        self._init_uniform_planes()
        # 构建hash_tables list. 长度为num_hashtables， 每一个值为一个storage对象(实质上storage是一个字典，字典的值是list类型)
    ...
    def _init_uniform_planes(self):
        ...
        if self.matrices_filename:
            ...
            # shape: (num_hash_table, hash_size, feature_dim)
            self.uniform_planes = [self._generate_uniform_planes()
                                   for _ in xrange(self.num_hashtables)]
    ...
    def _init_hashtables(self):
        ...
        # num_hashtables个storage  每一个storage 都是一个字典，字典的值是list类型
    ...
    def _hash(self, planes, input_point):
        ...
        :param input_point:
            ...
            The dimension needs to be (input_dim,).
        :return: hash value shape:(hash_size,)
        """

        try:
            # input_point: (embedding_dim,)  planes(hash_size, embedding_dim)
    ...
    def index(self, input_point, extra_data=None):
        ...
        :param input_point:
            ...
            only. The dimension needs to be (input_dim，).
        ...
        """
        # input_point 特征向量 shape:(embedding_dim,) 一维向量
